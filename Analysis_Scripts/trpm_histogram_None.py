...
#$ -V
#$ -N m5_his_n
#$ -e /cluster/uz_lab/cmives/TRP_channels/MDS/permeation_analysis/z_histogram/m5_his_none.err
#$ -o /cluster/uz_lab/cmives/TRP_channels/MDS/permeation_analysis/z_histogram/m5_his_none.out
#$ -pe smp 2
#$ -jc long
...
for ion_solution in ion_solution:
    ...
    for ionic_species in ionic_species:
        ...
        for replicate in ["repl_a","repl_b","repl_c"]:
            ...
            dir_stem = os.path.join(trpmds,protein,forcefield,construct,ion_solution,f"prodmd/no_field/{replicate}")
        ...
        df_histogram_file = f"count_analysis_NONE_{protein}_{construct}_{ion_solution}_{ionic_species}.csv"
